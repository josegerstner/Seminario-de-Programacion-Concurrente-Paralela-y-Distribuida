...
/*
 * Se pide: 2 m�todos diferentes de exclusi�n mutua entre los vistos 
 */
public class TP1 {
	...
	public TP1() {
		...
		mannaPnueli1 = new AlgoritmoDeMannaPnueli(1, 10);
		mannaPnueli2 = new AlgoritmoDeMannaPnueli(2, 30);
